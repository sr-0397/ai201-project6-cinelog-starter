...
from app import db
from models import CollectionEntry, Film, WatchlistEntry
from services.collection_service import FilmNotFoundError
from services.collection_service import AlreadyInCollectionError, NotInCollectionError


class AlreadyInWatchlistError(Exception):
    """Raised when a film_id is already in the watchlist."""
    pass
